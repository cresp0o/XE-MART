                    ...
                    <div class="col-lg-6 col-md-8">
                        <div class="top-right text-right">
                            ...
                            if(isset($_SESSION['client'])){ 
                                $id = $_SESSION['client'];
                                $select_client = $connect -> query("SELECT * FROM clients WHERE id =$id");
                                $row_client = $select_client -> fetch_assoc();
                            }
                            ?>
                            <ul class="list-unstyled list-inline">
                                <li class="list-inline-item"><a href="#"><img src="images/user.png" alt=""><?php  if(isset($_SESSION['client'])){ 
                               echo $row_client['firstname'];
                            }else{
                                echo "My Acount";
                            }
                            ?></a></li>
                                ...
                                if(!isset($_SESSION['client'])){ 
                                    echo " <a href='08-login.php'>Login</a>";
                                }else{
                                echo " <a href='admin/functions/logout_c.php'>logout</a>";
                                      }
                ...
                <div class="row">
                    ...
                    <div class="col-md-5 padding-fix">
                        <form action="#" class="search-bar">
                            <input type="text" placeholder="I'm looking for..." class="scontect">
                        ...
                        <div class="carts-area d-flex">
                            ...
                            <div class="cart-box ml-auto text-center">
                                <a href="#" class="cart-btn">
                                    ...
                                    <span class="c-order"><?php                            
                                $select_orders = $connect -> query("SELECT * FROM orders WHERE c_id='$id'");

                                $counters = $select_orders -> num_rows;
                                echo$counters;
                                   ?></span>
                                </a>
                            </div>
...
?>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-2">
                        <div class="carts-area d-flex">
                            <div class="src-box">
                                <form >
                                    <input type="text" name="search" placeholder="Search Here" class="scontect" >
                                ...
                                <div class="new-product">
                                    ...
                                    <?php 
                                        ...
                                        <div class="new-item">
                                            <div class="tab-heading">
                                                <ul class="list-unstyled list-inline">
                                                    <li class="list-inline-item"><a href="#"><?php if($row_product['cat_id']==1){echo"laptobs";}elseif($row_product['cat_id']==2){echo"tv";}elseif($row_product['cat_id']==3){echo"bikes";}elseif($row_product['cat_id']==4){echo"motorcycle";}?>,</a></li>
                                                    <li class="list-inline-item"><a href="#"><?php echo$row_product['name'] ?></a></li>
                                                </ul>
                                       
                                                <p><a href="05-single-product.php?id=<?php echo$row_product['id'];?>"><?php echo$row_product['description'];?></a></p>
                                            </div>
                                            <div class="new-img">
                                                <img class="main-img img-fluid" style="width:200px;height:150px;" src="admin/images/<?php
                                                     $img=explode('/',$row_product['image']);
                                                     echo $img[0];
                                                     
                                                ?>" alt="">
                                                <img class="sec-img img-fluid" style="width:200px;height:150px;" src="admin/images/<?php
                                                     $img=explode('/',$row_product['image']);
                                                     echo $img[1];?>" alt="">
                                                <div class="layer-box">
                                                    <a href="#" class="it-comp" data-toggle="tooltip" data-placement="left" title="Compare"><img src="images/it-comp.png" alt=""></a>
                                            ...
                                            <div class="img-content d-flex justify-content-between">
                                                <div>
                                                    <ul class="list-unstyled list-inline fav">
                                                        <li class="list-inline-item "><i class="fa <?php
                                                        $pro = $row_product['id'];
                                                        $cilent = $_SESSION['client'];
                                                        $select=$connect->query("SELECT * FROM rate WHERE product_id = '$pro' AND customer_id='$cilent'");
                                                        $rate = $select ->fetch_assoc();
                                                        if($rate['rate'] >= 1){
                                                            echo 'fa-star';
                                                        }else{
                                                            echo 'fa-star-o';
                                                        ...
                                                        ?> rate" index='1' product_id="<?php echo$row_product['id']?>" customer_id="<?php echo$_SESSION['client']?>"></i></li>
                                                        <li class="list-inline-item"><i class="fa <?php
                                                        $pro = $row_product['id'];
                                                        $cilent = $_SESSION['client'];
                                                        $select=$connect->query("SELECT * FROM rate WHERE product_id = '$pro' AND customer_id='$cilent'");
                                                        ...
                                                        ?> rate" index='2' product_id="<?php echo$row_product['id']?>" customer_id="<?php echo$_SESSION['client']?>"></i></li>
                                                        <li class="list-inline-item"><i class="fa <?php
                                                        $pro = $row_product['id'];
                                                        $cilent = $_SESSION['client'];
                                                        $select=$connect->query("SELECT * FROM rate WHERE product_id = '$pro' AND customer_id='$cilent'");
                                                        ...
                                                        ?> rate" index='3' product_id="<?php echo$row_product['id']?>" customer_id="<?php echo$_SESSION['client']?>"></i></li>
                                                        <li class="list-inline-item"><i class="fa <?php
                                                        $pro = $row_product['id'];
                                                        $cilent = $_SESSION['client'];
                                                        $select=$connect->query("SELECT * FROM rate WHERE product_id = '$pro' AND customer_id='$cilent'");
                                                        ...
                                                        ?> rate" index='4' product_id="<?php echo$row_product['id']?>" customer_id="<?php echo$_SESSION['client']?>"></i></li>
                                                        <li class="list-inline-item"><i class="fa <?php
                                                        $pro = $row_product['id'];
                                                        $cilent = $_SESSION['client'];
                                                        $select=$connect->query("SELECT * FROM rate WHERE product_id = '$pro' AND customer_id='$cilent'");
                                                        ...
                                                        ?> rate" index='5' product_id="<?php echo$row_product['id']?>" customer_id="<?php echo$_SESSION['client']?>"></i></li>
                                                    </ul>
                                                    <ul class="list-unstyled list-inline price">
                                                ...
                                                <div>
                                                    <a href="#" class="add-cart" data-toggle="tooltip" data-placement="top" title="Add to Cart" product_id="<?php echo$row_product['id']?>" customer_id="<?php echo$_SESSION['client']?>"><img src="images/it-cart.png" alt=""></a>
                                                </div>
                                            </div>
                                        </div>
        ...
        <script>
            $(".add-cart").click(function(s){
                s.preventDefault();
                var product_id=$(this).attr('product_id');
                var customer_id=$(this).attr('customer_id');
                
            $.post("admin/functions/order_product.php",{
        ...
        $(".del_carts").click(function(z){
            z.preventDefault();
            var product_id=$(this).attr('product_id');
            var customer_id=$(this).attr('customer_id');

            $.post("admin/functions/delete_order.php",{
                product_id:product_id,
                customer_id:customer_id
            },function(data){
                // $(".cart-content").load(location.href +".cart-content");
